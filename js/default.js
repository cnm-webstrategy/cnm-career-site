...
$(document).ready(function(){
    $('.new-cover').append('<section class="cover">\n' +
        '    <div class="flex">\n' +
        '               <div class="employee-login">\n' +
        '    <ul class="employee-wrapper">\n' +
        '        <div class="header">this is new Are you...</div>\n' +
...
//console.log('hello world script');
    ...
    $( document ).ready(function() {
        ...
        var apply_now_form = {
            ...
            get relayStateURL () {
                return 'https%253A%252F%252Fcnm.csod.com%252FEPM%252FCareerCenter%252FCareerCenter.aspx%253FreqID%253D'+ ReqID;
            },
            ...
            get CNMSSOIDP () {
                ...
                return 'https://cnm.csod.com/samldefault.aspx?ouid=3&returnUrl=/ats/careersite/JobDetails.aspx?id=' + this.relayStateURL;
            },
